...
当前官网下载包：v1.2.28（versionCode 33），约 5.5 MB，SHA-256 `597c53b2b596cf58622db4023dc63637632d1d0a61f50bec48dd4199174c0bfc`。本轮只动阅读精听：新增「下一句不显示」开关（开启后每跳一句自动重新隐藏原文与译文，开关只由用户手动关闭）；并统一「跳句即停」——上一句/下一句、切换逐句逐段、切换训练步骤、离开正文页都会立刻停掉正在播的音频，作废过期的「生成后播放」意图，不再出现「看着新句、听着旧句」。
